...
import tech.anonymousname.gradeer.checks.exceptions.NoCheckException;
...
public class CheckstyleProcess
{
    ...
    CheckstyleProcess(Solution sut, tech.anonymousname.gradeer.configuration.Configuration configuration, Collection<CheckstyleCheck> checkstyleChecks)
    {
        this.solution = sut;
        this.complete = false;
